...
public final class HomeViewModel_Factory implements Factory<HomeViewModel> {
  ...
  public HomeViewModel_Factory(Provider<RadioRepositoryImpl> repositoryProvider) {
  ...
  public static HomeViewModel_Factory create(Provider<RadioRepositoryImpl> repositoryProvider) {
    return new HomeViewModel_Factory(repositoryProvider);
  }

  public static HomeViewModel newInstance(RadioRepositoryImpl repository) {
