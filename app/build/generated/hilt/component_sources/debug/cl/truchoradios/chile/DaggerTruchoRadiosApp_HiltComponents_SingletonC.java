...
import cl.truchoradios.chile.di.AppModule_ProvideSettingsManagerFactory;
...
public final class DaggerTruchoRadiosApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends TruchoRadiosApp_HiltComponents.ActivityC {
    ...
    private MainActivity injectMainActivity2(MainActivity instance) {
      ...
      MainActivity_MembersInjector.injectSettingsManager(instance, singletonCImpl.provideSettingsManagerProvider.get());
      return instance;
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new FavoritesViewModel(singletonCImpl.provideRepositoryProvider.get(), singletonCImpl.providePlayerManagerProvider.get());

          case 1: // cl.truchoradios.chile.presentation.screens.player.FullPlayerViewModel 
          return (T) new FullPlayerViewModel(viewModelCImpl.savedStateHandle, singletonCImpl.provideRepositoryProvider.get(), singletonCImpl.providePlayerManagerProvider.get());
          ...
          return (T) new PlayerSharedViewModel(singletonCImpl.providePlayerManagerProvider.get(), singletonCImpl.provideSettingsManagerProvider.get());

          case 4: // cl.truchoradios.chile.presentation.screens.radiolist.RadioListViewModel 
          return (T) new RadioListViewModel(viewModelCImpl.savedStateHandle, singletonCImpl.provideRepositoryProvider.get(), singletonCImpl.providePlayerManagerProvider.get());

          case 5: // cl.truchoradios.chile.presentation.screens.search.SearchViewModel 
          return (T) new SearchViewModel(singletonCImpl.provideRepositoryProvider.get(), singletonCImpl.providePlayerManagerProvider.get());
  ...
  private static final class SingletonCImpl extends TruchoRadiosApp_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.provideSettingsManagerProvider = DoubleCheck.provider(new SwitchingProvider<SettingsManager>(singletonCImpl, 1));
      this.provideDatabaseProvider = DoubleCheck.provider(new SwitchingProvider<RadioDatabase>(singletonCImpl, 3));
      this.provideRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<RadioRepositoryImpl>(singletonCImpl, 2));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 1: // cl.truchoradios.chile.data.local.SettingsManager 
          return (T) AppModule_ProvideSettingsManagerFactory.provideSettingsManager();

          case 2: // cl.truchoradios.chile.data.repository.RadioRepositoryImpl 
          ...
          case 3: // cl.truchoradios.chile.data.local.RadioDatabase 
